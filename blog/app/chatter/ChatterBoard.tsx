              ...
              >
                {chatter.cover && (
                  ...
                  <div className="w-full h-28 md:h-52 overflow-hidden relative">
                    ...
                    {/* 核心修改 4：心情徽章微缩 */}
                    {chatter.mood && (
                      <span className="absolute top-2 right-2 md:top-4 md:right-4 bg-white/20 backdrop-blur-md text-white text-[8px] md:text-[10px] font-black px-2 py-1 md:px-3 md:py-1.5 rounded-full shadow-sm border border-white/20 uppercase tracking-widest inline-flex items-center gap-1">
                        <Sparkles size={10} /> {chatter.mood}
                      </span>
                    )}
                  </div>
                )}
